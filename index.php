<?php
$db = require 'db.php';
$items=$db->query("SELECT id, name, category, time_needs FROM recipes limit 3")->fetchAll(PDO::FETCH_ASSOC);
?>
<!doctype html>
                                ...
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">pages <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="recipes_details.php">Recipes Details</a></li> <!--переход по кнопке на детали блюда-->
